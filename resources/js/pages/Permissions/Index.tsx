...
export default function PermissionsIndex({
  permissions,
  isSuperAdmin: isSuperFromProps = false,
  flash,
  filters,
}: Props) {
  ...
  const allSelected =
    ...
    paginatedPermissions.every((r) => selectedPermissionIds.includes(r.id));
                ...
                <tbody className="divide-y divide-slate-200 dark:divide-slate-700">
                  {paginatedPermissions.length ? (
                    paginatedPermissions.map((permission) => {
                      const rowHasAction = permission.deleted_at
                        ? canRestore
